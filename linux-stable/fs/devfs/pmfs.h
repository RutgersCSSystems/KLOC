...
#define pmfs_dbg_verbose(s, args ...)		 \
	((pmfs_dbgmask & PMFS_DBGMASK_VERBOSE) ? pmfs_dbg(s "%s:%d", ##args,__FILE__, __LINE__) : 0)
...
void pmfs_update_inode(struct inode *inode, struct pmfs_inode *pi);
