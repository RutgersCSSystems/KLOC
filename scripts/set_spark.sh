...
QEMU_SET() {
	echo "export HDFS_NAMENODE_USER="sk2113"" &>> ~/.bashrc
	echo "export HDFS_DATANODE_USER="sk2113"" &>> ~/.bashrc
	echo "export HDFS_SECONDARYNAMENODE_USER="sk2113"" &>> ~/.bashrc
	echo "export YARN_RESOURCEMANAGER_USER="sk2113"" &>> ~/.bashrc
	echo "export YARN_NODEMANAGER_USER="sk2113"" &>> ~/.bashrc
}

ADD_SPARK_TO_BASHRC() {
	SPARK_HOME=$APPBENCH/apps/spark
	HADOOP_HOME=$SPARK_HOME/hadoop-3.2.1
	echo "export SPARK_HOME=/localhome/sudarsun/NVM/appbench/apps/spark" &>> ~/.bashrc
